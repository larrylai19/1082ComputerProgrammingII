...
{
    cout << endl << "      Date  Train No.     From        To  Departure  Arrival   Adult  Concession  Fare     Class\n";
    
    if (originStation < destinationStation)
    {
        SouthboundTimetable sou;

        cout << setw(10) << date
            << setw(11) << trainNumber
            << setw(9) << Station[originStation]
            << setw(10) << Station[destinationStation]
            << setw(11) << sou.getDepartureTimes(trainNumber, originStation)
            << setw(9) << sou.getDepartureTimes(trainNumber, destinationStation);

        if (carClass == 1)
        {
            cout << setw(5) << adultTicketPrice[destinationStation][originStation] << "*" << setw(2) << adultTickets
                << setw(9) << adultTicketPrice[destinationStation][originStation] / 2 << "*" << setw(2) << concessionTickets
                << setw(6) << adultTicketPrice[destinationStation][originStation] * adultTickets + adultTicketPrice[destinationStation][originStation] / 2 * concessionTickets
                << setw(11) << "Standard\n";
        }
        else
        {
            cout << setw(5) << adultTicketPrice[originStation][destinationStation] << "*" << setw(2) << adultTickets
                << setw(9) << adultTicketPrice[originStation][destinationStation] / 2 << "*" << setw(2) << concessionTickets
                << setw(6) << adultTicketPrice[originStation][destinationStation] * adultTickets + adultTicketPrice[originStation][destinationStation] / 2 * concessionTickets
                << setw(11) << "Business\n";
        }
    }
    else
    {
        NorthboundTimetable nor;

        cout << setw(10) << date
            << setw(11) << trainNumber
            << setw(9) << Station[originStation]
            << setw(10) << Station[destinationStation]
            << setw(11) << nor.getDepartureTimes(trainNumber, 13 - originStation)
            << setw(9) << nor.getDepartureTimes(trainNumber, 13 - destinationStation);

...
#include "Vector - 1083316 - hw7.h" // include definition of class template vector
#include "List - 1083316 - hw7.h"   // include definition of class template list
...
HugeInteger< T > HugeInteger< T >::operator-( HugeInteger< T > &op2 )
{
   ...
   for (int i = 0; it2 != op2.integer.end(); ++i, ++it2)
       temp[i] -= *it2;
   ...
   for (int i = 0; it3 != difference.integer.end(); ++it3, ++i)
       *it3 = temp[i];
...
HugeInteger< T > HugeInteger< T >::operator*( HugeInteger< T > &op2 )
{
   ...
   for (; it1 != integer.end(); ++it1, ++it3)
   {
       typename T::iterator temp = it2, temp2 = it3;
       for (; it2 != op2.integer.end(); ++it2, ++it3)
       {
           *it3 += *it1 * *it2;
           *++it3 += *--it3 / 10;
   ...
   for (int i = 0; it1 != integer.end(); ++i, ++it1)
       for (j = 0, it2 = op2.integer.begin(); it2 != op2.integer.end(); ++j, ++it2)
       {
           temp[i + j] += (*it1) * (*it2);
   ...
   typename T::iterator it3 = product.integer.begin();
   for (int i = 0; it3 != product.integer.end(); ++it3, ++i)
       *it3 = temp[i];
...
{ 
    ...
    for (unsigned int i = 0; i < n; ++i, ++it4);
